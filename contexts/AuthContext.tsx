...
export function AuthProvider({ children }: { children: React.ReactNode }) {
    ...
    const login = async (username: string, password: string): Promise<{ error: string | null }> => {
        try {
            ...
            // Client-side driver role gate (backend remains source of truth).
            // Using /drivers/me/ avoids relying on JWT payload shape and avoids
            // scanning /drivers/ list responses that may vary by permissions/pagination.
            try {
